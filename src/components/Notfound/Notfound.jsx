...
export default function Notfound() {
  return<>
        ...
        <div class=" w-50 py-5 mx-auto  text-center fw-bolder">
        ...
        <code>index.html</code>
            ...
            <p className=' my-2'>
                <a className=' text-decoration-line-throughe' href="https://help.github.com/pages/">Read the full documentation</a>
                for more information about using <strong>GitHub Pages</strong>
                .
      
            </p>
            <div className=' my-2' id="suggestions">
                <a href="https://githubstatus.com">GitHub Status</a>
                &mdash;<a href="https://twitter.com/githubstatus">@githubstatus</a>
            </div>
            <a href="/" className="mx-1 logo logo-img-1x">
            ...
            <a href="/" className="mx-1 logo logo-img-2x">
